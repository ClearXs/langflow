...
class RedisIndexChatMemory(LCChatMemoryComponent):
    ...
    inputs = [
        StrInput(
            name="host",
            display_name=i18n.t("components.redis.redis_chat.host.display_name"),
            required=True,
            value="localhost",
        ...
        IntInput(
            name="port",
            display_name=i18n.t("components.redis.redis_chat.port.display_name"),
            required=True,
            value=6379,
        ...
        StrInput(
            name="database",
            display_name=i18n.t("components.redis.redis_chat.database.display_name"),
            required=True,
            value="0",
        ...
        MessageTextInput(
            name="username",
            display_name=i18n.t("components.redis.redis_chat.username.display_name"),
            value="",
        ...
        SecretStrInput(
            name="password",
            display_name=i18n.t("components.redis.redis_chat.password.display_name"),
            value="",
        ...
        StrInput(
            name="key_prefix",
            display_name=i18n.t("components.redis.redis_chat.key_prefix.display_name"),
            info=i18n.t("components.redis.redis_chat.key_prefix.info"),
            advanced=True,
        ),
        MessageTextInput(
            name="session_id",
            display_name=i18n.t("components.redis.redis_chat.session_id.display_name"),
