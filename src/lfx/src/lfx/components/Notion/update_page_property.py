...
class NotionPageUpdate(LCToolComponent):
    display_name: str = i18n.t("components.notion.update_page_property.display_name")
    description: str = i18n.t("components.notion.update_page_property.description")
    ...
    inputs = [
        StrInput(
            name="page_id",
            display_name=i18n.t("components.notion.update_page_property.page_id.display_name"),
            info=i18n.t("components.notion.update_page_property.page_id.info"),
        ),
        MultilineInput(
            name="properties",
            display_name=i18n.t("components.notion.update_page_property.properties.display_name"),
            info=i18n.t("components.notion.update_page_property.properties.info"),
        ),
        SecretStrInput(
            name="notion_secret",
            display_name=i18n.t("components.notion.update_page_property.notion_secret.display_name"),
            info=i18n.t("components.notion.update_page_property.notion_secret.info"),
            required=True,
        ),
    ]
