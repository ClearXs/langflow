...
class AddContentToPage(LCToolComponent):
    display_name: str = i18n.t("components.notion.add_content_to_page.display_name")
    description: str = i18n.t("components.notion.add_content_to_page.description")
    ...
    inputs = [
        MultilineInput(
            name="markdown_text",
            display_name=i18n.t("components.notion.add_content_to_page.markdown_text.display_name"),
            info=i18n.t("components.notion.add_content_to_page.markdown_text.info"),
        ),
        StrInput(
            name="block_id",
            display_name=i18n.t("components.notion.add_content_to_page.block_id.display_name"),
            info=i18n.t("components.notion.add_content_to_page.block_id.info"),
        ),
        SecretStrInput(
            name="notion_secret",
            display_name=i18n.t("components.notion.add_content_to_page.notion_secret.display_name"),
            info=i18n.t("components.notion.add_content_to_page.notion_secret.info"),
            required=True,
        ),
    ]
