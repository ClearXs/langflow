...
class SambaNovaComponent(LCModelComponent):
    ...
    inputs = [
        *LCModelComponent.get_base_inputs(),
        StrInput(
            name="base_url",
            display_name=i18n.t("components.sambanova.sambanova.base_url.display_name"),
            advanced=True,
            info=i18n.t("components.sambanova.sambanova.base_url.info"),
        ),
        DropdownInput(
            name="model_name",
            display_name=i18n.t("components.sambanova.sambanova.model_name.display_name"),
            advanced=False,
        ...
        SecretStrInput(
            name="api_key",
            display_name=i18n.t("components.sambanova.sambanova.api_key.display_name"),
        ...
        IntInput(
            name="max_tokens",
            display_name=i18n.t("components.sambanova.sambanova.max_tokens.display_name"),
            advanced=True,
            value=2048,
        ...
        SliderInput(
            name="top_p",
            display_name=i18n.t("components.sambanova.sambanova.top_p.display_name"),
            advanced=True,
            value=1.0,
        ...
        SliderInput(
            name="temperature",
            display_name=i18n.t("components.sambanova.sambanova.temperature.display_name"),
            value=0.1,
