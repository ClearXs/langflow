...
class HtmlLinkExtractorComponent(LCDocumentTransformerComponent):
    ...
    display_name = i18n.t("components.langchain_utilities.html_link_extractor.display_name")
    description = i18n.t("components.langchain_utilities.html_link_extractor.description")
    ...
    inputs = [
        StrInput(
            name="kind",
            display_name=i18n.t("components.langchain_utilities.html_link_extractor.kind.display_name"),
            info=i18n.t("components.langchain_utilities.html_link_extractor.kind.info"),
            value="hyperlink",
            required=False,
        ),
        BoolInput(
            name="drop_fragments",
            display_name=i18n.t("components.langchain_utilities.html_link_extractor.drop_fragments.display_name"),
            info=i18n.t("components.langchain_utilities.html_link_extractor.drop_fragments.info"),
            value=True,
            required=False,
        ),
        DataInput(
            name="data_input",
            display_name=i18n.t("components.langchain_utilities.html_link_extractor.data_input.display_name"),
            info=i18n.t("components.langchain_utilities.html_link_extractor.data_input.info"),
