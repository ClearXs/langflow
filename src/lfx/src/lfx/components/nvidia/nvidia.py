...
class NVIDIAModelComponent(LCModelComponent):
    ...
    inputs = [
        *LCModelComponent.get_base_inputs(),
        IntInput(
            name="max_tokens",
            display_name=i18n.t("components.nvidia.nvidia.max_tokens.display_name"),
            advanced=True,
            info=i18n.t("components.nvidia.nvidia.max_tokens.info"),
        ),
        DropdownInput(
            name="model_name",
            display_name=i18n.t("components.nvidia.nvidia.model_name.display_name"),
        ...
        BoolInput(
            ...
            display_name=i18n.t("components.nvidia.nvidia.detailed_thinking.display_name"),
        ...
        BoolInput(
            ...
            display_name=i18n.t("components.nvidia.nvidia.tool_model_enabled.display_name"),
        ...
        MessageTextInput(
            name="base_url",
            display_name=i18n.t("components.nvidia.nvidia.base_url.display_name"),
            value="https://integrate.api.nvidia.com/v1",
            info=i18n.t("components.nvidia.nvidia.base_url.info"),
        ),
        SecretStrInput(
            name="api_key",
            display_name=i18n.t("components.nvidia.nvidia.api_key.display_name"),
        ...
        SliderInput(
            name="temperature",
            display_name=i18n.t("components.nvidia.nvidia.temperature.display_name"),
            value=0.1,
