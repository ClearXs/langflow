...
class ETLDataCleaningComponent(Component):
    ...
    inputs = [
        ...
        BoolInput(
            ...
            display_name=i18n.t("components.manipulations.data_cleaning.trim_whitespace.display_name"),
            info=i18n.t("components.manipulations.data_cleaning.trim_whitespace.info"),
            value=True,
        ),
        BoolInput(
            name="remove_duplicates",
            display_name=i18n.t("components.manipulations.data_cleaning.remove_duplicates.display_name"),
            info=i18n.t("components.manipulations.data_cleaning.remove_duplicates.info"),
            value=False,
        ),
        BoolInput(
            name="remove_null_rows",
            display_name=i18n.t("components.manipulations.data_cleaning.remove_null_rows.display_name"),
            info=i18n.t("components.manipulations.data_cleaning.remove_null_rows.info"),
            value=False,
        ),
        BoolInput(
            name="remove_special_chars",
            display_name=i18n.t("components.manipulations.data_cleaning.remove_special_chars.display_name"),
            info=i18n.t("components.manipulations.data_cleaning.remove_special_chars.info"),
            value=False,
            advanced=True,
        ),
        BoolInput(
            name="normalize_case",
            display_name=i18n.t("components.manipulations.data_cleaning.normalize_case.display_name"),
            info=i18n.t("components.manipulations.data_cleaning.normalize_case.info"),
            value=False,
            advanced=True,
        ),
        DropdownInput(
            name="case_type",
            display_name=i18n.t("components.manipulations.data_cleaning.case_type.display_name"),
            info=i18n.t("components.manipulations.data_cleaning.case_type.info"),
