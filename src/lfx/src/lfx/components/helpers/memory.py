...
class MemoryComponent(Component):
    ...
    inputs = [
        TabInput(
            ...
            options=[i18n.t("components.helpers.memory.mode.retrieve"), i18n.t("components.helpers.memory.mode.store")],
        ...
        MessageTextInput(
            name="message",
            display_name=i18n.t("components.helpers.memory.message.display_name"),
        ...
        HandleInput(
            name="memory",
            display_name=i18n.t("components.helpers.memory.external_memory.display_name"),
            input_types=["Memory"],
        ...
        DropdownInput(
            name="sender_type",
            display_name=i18n.t("components.helpers.memory.sender_type.display_name"),
            options=[
                MESSAGE_SENDER_AI,
                MESSAGE_SENDER_USER,
                i18n.t("components.helpers.memory.sender_type.machine_and_user"),
            ],
            value=i18n.t("components.helpers.memory.sender_type.machine_and_user"),
            info=i18n.t("components.helpers.memory.sender_type.info"),
            advanced=True,
        ),
        MessageTextInput(
            name="sender",
            display_name=i18n.t("components.helpers.memory.sender.display_name"),
            info=i18n.t("components.helpers.memory.sender.info"),
            advanced=True,
        ),
        MessageTextInput(
            name="sender_name",
            display_name=i18n.t("components.helpers.memory.sender_name.display_name"),
        ...
        IntInput(
            name="n_messages",
            display_name=i18n.t("components.helpers.memory.n_messages.display_name"),
            value=100,
        ...
        MessageTextInput(
            name="session_id",
            display_name=i18n.t("components.helpers.memory.session_id.display_name"),
        ...
        DropdownInput(
            name="order",
            display_name=i18n.t("components.helpers.memory.order.display_name"),
            options=[
                i18n.t("components.helpers.memory.order.ascending"),
        ...
        MultilineInput(
            name="template",
            display_name=i18n.t("components.helpers.memory.template.display_name"),
    ...
    outputs = [
        Output(
            display_name=i18n.t("components.helpers.memory.outputs.message.display_name"),
            name="messages_text",
            method="retrieve_messages_as_text",
            dynamic=True,
        ),
        Output(
            display_name=i18n.t("components.helpers.memory.outputs.dataframe.display_name"),
            name="dataframe",
    ...
    def update_outputs(self, frontend_node: dict, field_name: str, field_value: Any) -> dict:
        ...
        if field_name == "mode":
            ...
            if field_value in ["Store", i18n.t("components.helpers.memory.mode.store")]:
                frontend_node["outputs"] = [
                    Output(
                        display_name=i18n.t("components.helpers.memory.outputs.stored_messages.display_name"),
            ...
            if field_value in ["Retrieve", i18n.t("components.helpers.memory.mode.retrieve")]:
                frontend_node["outputs"] = [
                    Output(
                        display_name=i18n.t("components.helpers.memory.outputs.messages.display_name"),
                        name="messages_text",
                        method="retrieve_messages_as_text",
                        dynamic=True,
                    ),
    ...
    async def store_message(self) -> Message:
        try:
            ...
            if not stored_messages:
                error_msg = i18n.t("components.helpers.memory.errors.no_messages_stored")
                raise ValueError(error_msg)

            stored_message = stored_messages[0]
            success_msg = i18n.t(
                "components.helpers.memory.success.message_stored",
            ...
            error_msg = i18n.t("components.helpers.memory.errors.store_failed", error=str(e))
    ...
    async def retrieve_messages(self) -> Data:
        try:
            ...
            order = (
                "DESC" if self.order in ["Descending", i18n.t("components.helpers.memory.order.descending")] else "ASC"
            )
            ...
            if self.memory and not hasattr(self.memory, "aget_messages"):
                ...
                err_msg = i18n.t("components.helpers.memory.errors.invalid_external_memory", memory_name=memory_name)
            ...
            success_msg = i18n.t(
                "components.helpers.memory.success.messages_retrieved", count=len(stored), session_id=session_id
            )
            self.status = success_msg
            ...
            error_msg = i18n.t("components.helpers.memory.errors.retrieve_failed", error=str(e))
            self.status = error_msg
            raise ValueError(error_msg) from e
    ...
    async def retrieve_messages_as_text(self) -> Message:
        try:
            ...
            success_msg = i18n.t("components.helpers.memory.success.text_formatted")
            self.status = success_msg

            return Message(text=stored_text)

        except Exception as e:
            error_msg = i18n.t("components.helpers.memory.errors.text_formatting_failed", error=str(e))
            self.status = error_msg
    ...
    async def retrieve_messages_dataframe(self) -> DataFrame:
        ...
        try:
            ...
            success_msg = i18n.t("components.helpers.memory.success.dataframe_created", rows=len(messages))
            self.status = success_msg

            return dataframe

        except Exception as e:
            error_msg = i18n.t("components.helpers.memory.errors.dataframe_creation_failed", error=str(e))
            self.status = error_msg
            return DataFrame([])
