...
class TwelveLabsVideoEmbeddingsComponent(LCEmbeddingsModel):
    display_name = i18n.t("components.twelvelabs.video_embeddings.display_name")
    ...
    inputs = [
        SecretStrInput(
            name="api_key",
            display_name=i18n.t("components.twelvelabs.video_embeddings.api_key.display_name"),
            required=True,
        ),
        DropdownInput(
            name="model_name",
            display_name=i18n.t("components.twelvelabs.video_embeddings.model_name.display_name"),
            advanced=False,
        ...
        IntInput(
            ...
            display_name=i18n.t("components.twelvelabs.video_embeddings.request_timeout.display_name"),
            advanced=True,
        ),
    ]
