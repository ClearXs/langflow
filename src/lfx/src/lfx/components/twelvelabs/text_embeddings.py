...
class TwelveLabsTextEmbeddingsComponent(LCEmbeddingsModel):
    ...
    inputs = [
        SecretStrInput(
            name="api_key",
            display_name=i18n.t("components.twelvelabs.text_embeddings.api_key.display_name"),
            value="TWELVELABS_API_KEY",
            required=True,
        ),
        DropdownInput(
            name="model",
            display_name=i18n.t("components.twelvelabs.text_embeddings.model.display_name"),
            advanced=False,
        ...
        IntInput(
            name="max_retries",
            display_name=i18n.t("components.twelvelabs.text_embeddings.max_retries.display_name"),
            value=3,
            advanced=True,
        ),
        FloatInput(
            name="request_timeout",
            display_name=i18n.t("components.twelvelabs.text_embeddings.request_timeout.display_name"),
            advanced=True,
        ),
    ]
