...
class MongoVectorStoreComponent(LCVectorStoreComponent):
    ...
    inputs = [
        SecretStrInput(
            ...
            display_name=i18n.t("components.vectorstores.mongodb_atlas.mongodb_atlas_cluster_uri.display_name"),
            required=True,
        ),
        BoolInput(
            name="enable_mtls",
            display_name=i18n.t("components.vectorstores.mongodb_atlas.enable_mtls.display_name"),
            value=False,
            advanced=True,
            required=True,
        ),
        SecretStrInput(
            ...
            display_name=i18n.t("components.vectorstores.mongodb_atlas.mongodb_atlas_client_cert.display_name"),
            required=False,
            info=i18n.t("components.vectorstores.mongodb_atlas.mongodb_atlas_client_cert.info"),
        ),
        StrInput(
            name="db_name",
            display_name=i18n.t("components.vectorstores.mongodb_atlas.db_name.display_name"),
            required=True,
        ),
        StrInput(
            name="collection_name",
            display_name=i18n.t("components.vectorstores.mongodb_atlas.collection_name.display_name"),
            required=True,
        ),
        StrInput(
            name="index_name",
            display_name=i18n.t("components.vectorstores.mongodb_atlas.index_name.display_name"),
            required=True,
            info=i18n.t("components.vectorstores.mongodb_atlas.index_name.info"),
        ),
        *LCVectorStoreComponent.inputs,
        DropdownInput(
            name="insert_mode",
            display_name=i18n.t("components.vectorstores.mongodb_atlas.insert_mode.display_name"),
            options=INSERT_MODES,
            value=INSERT_MODES[0],
            info=i18n.t("components.vectorstores.mongodb_atlas.insert_mode.info"),
            advanced=True,
        ),
        HandleInput(
            name="embedding",
            display_name=i18n.t("components.vectorstores.mongodb_atlas.embedding.display_name"),
            input_types=["Embeddings"],
        ),
        IntInput(
            name="number_of_results",
            display_name=i18n.t("components.vectorstores.mongodb_atlas.number_of_results.display_name"),
            info=i18n.t("components.vectorstores.mongodb_atlas.number_of_results.info"),
            value=4,
            advanced=True,
        ),
        StrInput(
            name="index_field",
            display_name=i18n.t("components.vectorstores.mongodb_atlas.index_field.display_name"),
            advanced=True,
            required=True,
            info=i18n.t("components.vectorstores.mongodb_atlas.index_field.info"),
            value="embedding",
        ),
        StrInput(
            name="filter_field",
            display_name=i18n.t("components.vectorstores.mongodb_atlas.filter_field.display_name"),
            advanced=True,
            info=i18n.t("components.vectorstores.mongodb_atlas.filter_field.info"),
        ),
        IntInput(
            name="number_dimensions",
            display_name=i18n.t("components.vectorstores.mongodb_atlas.number_dimensions.display_name"),
            info=i18n.t("components.vectorstores.mongodb_atlas.number_dimensions.info"),
            value=1536,
            advanced=True,
            required=True,
        ),
        DropdownInput(
            name="similarity",
            display_name=i18n.t("components.vectorstores.mongodb_atlas.similarity.display_name"),
            options=SIMILARITY_OPTIONS,
            value=SIMILARITY_OPTIONS[0],
            info=i18n.t("components.vectorstores.mongodb_atlas.similarity.info"),
            advanced=True,
        ),
        DropdownInput(
            name="quantization",
            display_name=i18n.t("components.vectorstores.mongodb_atlas.quantization.display_name"),
            options=QUANTIZATION_OPTIONS,
            value=None,
            info=i18n.t("components.vectorstores.mongodb_atlas.quantization.info"),
            advanced=True,
        ),
    ]
