...
class ClickHouseOutputComponent(BaseSQLOutputComponent):
    ...
    inputs = [
        ...
        DropdownInput(
            ...
            options=[
                i18n.t("components.input_output.databases.clickhouse_output.write_mode.append"),
                i18n.t("components.input_output.databases.clickhouse_output.write_mode.overwrite"),
                i18n.t("components.input_output.databases.clickhouse_output.write_mode.fail"),
            ],
            value=i18n.t("components.input_output.databases.clickhouse_output.write_mode.append"),
            advanced=False,
        ),
        BoolInput(
