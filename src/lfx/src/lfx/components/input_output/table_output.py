...
class ETLTableOutputComponent(Component):
    ...
    inputs = [
        ...
        MessageTextInput(
            ...
            display_name=i18n.t("components.input_output.table_output.connection_string.display_name"),
            info=i18n.t("components.input_output.table_output.connection_string.info"),
            required=True,
        ),
        MessageTextInput(
            name="table_name",
            display_name=i18n.t("components.input_output.table_output.table_name.display_name"),
            info=i18n.t("components.input_output.table_output.table_name.info"),
            required=True,
        ),
        DropdownInput(
            name="write_mode",
            ...
            options=["append", "replace", "upsert", "fail"],
            value="append",
        ),
        TableInput(
            name="key_columns",
            display_name=i18n.t("components.input_output.table_output.key_columns.display_name"),
            info=i18n.t("components.input_output.table_output.key_columns.info"),
            table_schema=[{"name": "column", "display_name": "Column", "type": "str"}],
            value=[],
            advanced=True,
        ),
        BoolInput(
        ...
        BoolInput(
            name="truncate_first",
            display_name=i18n.t("components.input_output.table_output.truncate_first.display_name"),
            info=i18n.t("components.input_output.table_output.truncate_first.info"),
            value=False,
            advanced=True,
        ),
    ]
