...
class DataFrameOperationsComponent(Component):
    ...
    display_name = i18n.t("components.processing.dataframe_operations.display_name")
    description = i18n.t("components.processing.dataframe_operations.description")
    ...
    inputs = [
        DataFrameInput(
            name="df",
            display_name=i18n.t("components.processing.dataframe_operations.df.display_name"),
            info=i18n.t("components.processing.dataframe_operations.df.info"),
            required=True,
        ),
        SortableListInput(
            name="operation",
            display_name=i18n.t("components.processing.dataframe_operations.operation.display_name"),
            placeholder=i18n.t("components.processing.dataframe_operations.operation.placeholder"),
            info=i18n.t("components.processing.dataframe_operations.operation.info"),
            options=[
                {"name": i18n.t("components.processing.dataframe_operations.operations.add_column"), "icon": "plus"},
                {"name": i18n.t("components.processing.dataframe_operations.operations.drop_column"), "icon": "minus"},
                {"name": i18n.t("components.processing.dataframe_operations.operations.filter"), "icon": "filter"},
                {"name": i18n.t("components.processing.dataframe_operations.operations.head"), "icon": "arrow-up"},
                {
                    "name": i18n.t("components.processing.dataframe_operations.operations.rename_column"),
                    "icon": "pencil",
                },
                {
                    "name": i18n.t("components.processing.dataframe_operations.operations.replace_value"),
                    "icon": "replace",
                },
                {
                    "name": i18n.t("components.processing.dataframe_operations.operations.select_columns"),
                    "icon": "columns",
                },
                {"name": i18n.t("components.processing.dataframe_operations.operations.sort"), "icon": "arrow-up-down"},
                {"name": i18n.t("components.processing.dataframe_operations.operations.tail"), "icon": "arrow-down"},
                {
                    "name": i18n.t("components.processing.dataframe_operations.operations.drop_duplicates"),
                    "icon": "copy-x",
                },
            ],
        ...
        StrInput(
            name="column_name",
            display_name=i18n.t("components.processing.dataframe_operations.column_name.display_name"),
            info=i18n.t("components.processing.dataframe_operations.column_name.info"),
            dynamic=True,
            show=False,
        ),
        MessageTextInput(
            name="filter_value",
            display_name=i18n.t("components.processing.dataframe_operations.filter_value.display_name"),
            info=i18n.t("components.processing.dataframe_operations.filter_value.info"),
            dynamic=True,
            show=False,
        ),
        DropdownInput(
            name="filter_operator",
            display_name=i18n.t("components.processing.dataframe_operations.filter_operator.display_name"),
            options=[
                i18n.t("components.processing.dataframe_operations.filter_operators.equals"),
                i18n.t("components.processing.dataframe_operations.filter_operators.not_equals"),
                i18n.t("components.processing.dataframe_operations.filter_operators.contains"),
                i18n.t("components.processing.dataframe_operations.filter_operators.not_contains"),
                i18n.t("components.processing.dataframe_operations.filter_operators.starts_with"),
                i18n.t("components.processing.dataframe_operations.filter_operators.ends_with"),
                i18n.t("components.processing.dataframe_operations.filter_operators.greater_than"),
                i18n.t("components.processing.dataframe_operations.filter_operators.less_than"),
            ],
            value=i18n.t("components.processing.dataframe_operations.filter_operators.equals"),
            info=i18n.t("components.processing.dataframe_operations.filter_operator.info"),
            advanced=False,
            dynamic=True,
            show=False,
        ),
        BoolInput(
            name="ascending",
            display_name=i18n.t("components.processing.dataframe_operations.ascending.display_name"),
            info=i18n.t("components.processing.dataframe_operations.ascending.info"),
            dynamic=True,
            show=False,
            value=True,
        ),
        StrInput(
            ...
            display_name=i18n.t("components.processing.dataframe_operations.new_column_name.display_name"),
            info=i18n.t("components.processing.dataframe_operations.new_column_name.info"),
            dynamic=True,
            show=False,
        ),
        MessageTextInput(
            name="new_column_value",
            display_name=i18n.t("components.processing.dataframe_operations.new_column_value.display_name"),
            info=i18n.t("components.processing.dataframe_operations.new_column_value.info"),
            dynamic=True,
            show=False,
        ),
        StrInput(
            name="columns_to_select",
            display_name=i18n.t("components.processing.dataframe_operations.columns_to_select.display_name"),
            info=i18n.t("components.processing.dataframe_operations.columns_to_select.info"),
            dynamic=True,
            is_list=True,
            show=False,
        ),
        IntInput(
            name="num_rows",
            display_name=i18n.t("components.processing.dataframe_operations.num_rows.display_name"),
            info=i18n.t("components.processing.dataframe_operations.num_rows.info"),
            dynamic=True,
            show=False,
            value=5,
        ),
        MessageTextInput(
            name="replace_value",
            display_name=i18n.t("components.processing.dataframe_operations.replace_value.display_name"),
            info=i18n.t("components.processing.dataframe_operations.replace_value.info"),
            dynamic=True,
            show=False,
        ),
        MessageTextInput(
            name="replacement_value",
            display_name=i18n.t("components.processing.dataframe_operations.replacement_value.display_name"),
            info=i18n.t("components.processing.dataframe_operations.replacement_value.info"),
            dynamic=True,
            show=False,
        ),
    ]
    ...
    outputs = [
        Output(
            display_name=i18n.t("components.processing.dataframe_operations.outputs.dataframe.display_name"),
            name="output",
            method="perform_operation",
            info=i18n.t("components.processing.dataframe_operations.outputs.dataframe.info"),
        )
    ]
    ...
    def perform_operation(self) -> DataFrame:
        try:
            ...
            if not op:
                warning_msg = i18n.t("components.processing.dataframe_operations.warnings.no_operation_selected")
            ...
            if method_name and hasattr(self, method_name):
                ...
                success_msg = i18n.t(
                    "components.processing.dataframe_operations.success.operation_completed",
                    operation=op,
                    rows=len(result),
                )
                self.status = success_msg
                return result
            error_msg = i18n.t("components.processing.dataframe_operations.errors.unsupported_operation", operation=op)
            self.status = error_msg
            logger.error(error_msg)
            raise ValueError(error_msg)

        except Exception as e:
            error_msg = i18n.t("components.processing.dataframe_operations.errors.operation_failed", error=str(e))
            self.status = error_msg
            logger.error(error_msg)
    ...
    def filter_rows_by_value(self, df: DataFrame) -> DataFrame:
        try:
            if self.column_name not in df.columns:
                ...
                error_msg = i18n.t(
                    "components.processing.dataframe_operations.errors.column_not_found",
            ...
            operator = getattr(
                self, "filter_operator", i18n.t("components.processing.dataframe_operations.filter_operators.equals")
            )
            ...
            error_msg = i18n.t("components.processing.dataframe_operations.errors.filter_failed", error=str(e))
            raise ValueError(error_msg) from e
    ...
    def sort_by_column(self, df: DataFrame) -> DataFrame:
        try:
            ...
            error_msg = i18n.t("components.processing.dataframe_operations.errors.sort_failed", error=str(e))
            raise ValueError(error_msg) from e
    ...
    def drop_column(self, df: DataFrame) -> DataFrame:
        try:
            ...
            error_msg = i18n.t("components.processing.dataframe_operations.errors.drop_column_failed", error=str(e))
            raise ValueError(error_msg) from e
    ...
    def rename_column(self, df: DataFrame) -> DataFrame:
        try:
            ...
            if not self.new_column_name or not self.new_column_name.strip():
                error_msg = i18n.t("components.processing.dataframe_operations.errors.new_column_name_required")
                raise ValueError(error_msg)

            return DataFrame(df.rename(columns={self.column_name: self.new_column_name}))

        except Exception as e:
            error_msg = i18n.t("components.processing.dataframe_operations.errors.rename_column_failed", error=str(e))
            raise ValueError(error_msg) from e
    ...
    def add_column(self, df: DataFrame) -> DataFrame:
        try:
            ...
            error_msg = i18n.t("components.processing.dataframe_operations.errors.add_column_failed", error=str(e))
            raise ValueError(error_msg) from e

    def select_columns(self, df: DataFrame) -> DataFrame:
        try:
            if not self.columns_to_select:
                error_msg = i18n.t("components.processing.dataframe_operations.errors.columns_to_select_required")
                raise ValueError(error_msg)

            columns = [col.strip() for col in self.columns_to_select if col.strip()]

            if not columns:
                error_msg = i18n.t("components.processing.dataframe_operations.errors.no_valid_columns")
                raise ValueError(error_msg)
            ...
            if missing_columns:
                available_cols = ", ".join(df.columns)
                error_msg = i18n.t(
                    "components.processing.dataframe_operations.errors.columns_not_found",
            ...
            error_msg = i18n.t("components.processing.dataframe_operations.errors.select_columns_failed", error=str(e))
            raise ValueError(error_msg) from e

    def head(self, df: DataFrame) -> DataFrame:
        try:
            if self.num_rows < 1:
                error_msg = i18n.t("components.processing.dataframe_operations.errors.invalid_num_rows")
                raise ValueError(error_msg)

            return DataFrame(df.head(self.num_rows))

        except Exception as e:
            error_msg = i18n.t("components.processing.dataframe_operations.errors.head_failed", error=str(e))
            raise ValueError(error_msg) from e
    ...
    def tail(self, df: DataFrame) -> DataFrame:
        try:
            ...
            error_msg = i18n.t("components.processing.dataframe_operations.errors.tail_failed", error=str(e))
            raise ValueError(error_msg) from e
    ...
    def replace_values(self, df: DataFrame) -> DataFrame:
        try:
            ...
            error_msg = i18n.t("components.processing.dataframe_operations.errors.replace_values_failed", error=str(e))
            raise ValueError(error_msg) from e
    ...
    def drop_duplicates(self, df: DataFrame) -> DataFrame:
        try:
            ...
            error_msg = i18n.t("components.processing.dataframe_operations.errors.drop_duplicates_failed", error=str(e))
            raise ValueError(error_msg) from e
