...
class MilvusVectorStoreComponent(LCVectorStoreComponent):
    ...
    inputs = [
        StrInput(
            ...
            display_name=i18n.t("components.milvus.milvus.collection_name.display_name"),
            value="langflow",
            info=i18n.t("components.milvus.milvus.collection_name.info"),
        ),
        StrInput(
            name="collection_description",
            display_name=i18n.t("components.milvus.milvus.collection_description.display_name"),
            value="",
            info=i18n.t("components.milvus.milvus.collection_description.info"),
        ),
        StrInput(
            name="uri",
        ...
        SecretStrInput(
            name="password",
            display_name=i18n.t("components.milvus.milvus.password.display_name"),
            value="",
            info=i18n.t("components.milvus.milvus.password.info"),
        ),
        DictInput(
            name="connection_args",
            display_name=i18n.t("components.milvus.milvus.connection_args.display_name"),
            advanced=True,
            info=i18n.t("components.milvus.milvus.connection_args.info"),
        ),
        StrInput(
            name="primary_field",
            display_name=i18n.t("components.milvus.milvus.primary_field.display_name"),
            value="pk",
            info=i18n.t("components.milvus.milvus.primary_field.info"),
        ),
        StrInput(
            name="text_field",
            display_name=i18n.t("components.milvus.milvus.text_field.display_name"),
            value="text",
            info=i18n.t("components.milvus.milvus.text_field.info"),
        ),
        StrInput(
            name="vector_field",
            display_name=i18n.t("components.milvus.milvus.vector_field.display_name"),
            value="vector",
            info=i18n.t("components.milvus.milvus.vector_field.info"),
        ),
        DropdownInput(
            name="consistency_level",
            display_name=i18n.t("components.milvus.milvus.consistency_level.display_name"),
        ...
        DictInput(
            name="index_params",
            display_name=i18n.t("components.milvus.milvus.index_params.display_name"),
            advanced=True,
            info=i18n.t("components.milvus.milvus.index_params.info"),
        ),
        DictInput(
            name="search_params",
            display_name=i18n.t("components.milvus.milvus.search_params.display_name"),
            advanced=True,
            info=i18n.t("components.milvus.milvus.search_params.info"),
        ),
        BoolInput(
            name="drop_old",
            display_name=i18n.t("components.milvus.milvus.drop_old.display_name"),
            value=False,
            advanced=True,
        ...
        FloatInput(
            name="timeout",
            display_name=i18n.t("components.milvus.milvus.timeout.display_name"),
            advanced=True,
        ...
        *LCVectorStoreComponent.inputs,
        HandleInput(
            name="embedding",
            display_name=i18n.t("components.milvus.milvus.embedding.display_name"),
            input_types=["Embeddings"],
        ),
        IntInput(
            name="number_of_results",
            display_name=i18n.t("components.milvus.milvus.number_of_results.display_name"),
