...
const NodeToolbarComponent = memo(
  ({
    ...
    const handleMinimize = useCallback(() => {
      ...
      setNoticeData({
        title: t("common.minimizationOnlyAvailable"),
      });
    ...
    const saveComponent = useCallback(() => {
      ...
      setSuccessData({ title: `${data.id} ${t("common.savedSuccessfully")}` });
    }, [isSaved, data.id, flowComponent, addFlow, t]);
    ...
    }, [data.id, data.node?.documentation, t]);
