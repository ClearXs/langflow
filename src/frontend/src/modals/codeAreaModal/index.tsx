      ...
      <BaseModal.Content overflowHidden={true}>
        ...
        <div className="flex h-full w-full flex-col transition-all">
          ...
          <Collapsible
            ...
            className="mb-2 rounded-md bg-muted"
          >
            <div className="flex items-center gap-2 px-3 py-2">
              ...
              <div className="flex-1 text-xs">
                <span className="text-muted-foreground">
                  {t("variable.codeArea.hint")}
                </span>
                {allVariables.length > 0 && (
                  <span className="ml-2 font-mono text-muted-foreground">
                    {t("variable.codeArea.availableCount", {
        ...
        <ConfirmationModal
          ...
          cancelText={t("codeAreaModal.cancelText")}
          ...
          title={t("codeAreaModal.title")}
        >
          <ConfirmationModal.Content>
            <p>{t("codeAreaModal.confirmationText")}</p>
          </ConfirmationModal.Content>
        </ConfirmationModal>
      </BaseModal.Content>
    </BaseModal>
