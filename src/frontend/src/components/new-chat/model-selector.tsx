...
export function ModelSelector({
  ...
  const handleSelectConfig = useCallback(
    async (config: LLMConfigRead | GlobalLLMConfigRead) => {
        ...
        >
          {isLoading ? (
            ...
            <>
              ...
              >
                {currentConfig.model.split("/").pop()?.slice(0, 15) ||
                  currentConfig.model.slice(0, 15)}
              </Badge>
            </>
          ) : (
            <>
