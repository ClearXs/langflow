    ...
    <section className="py-2 md:py-8 dark:bg-transparent">
      <div className="@container mx-auto max-w-7xl">
        <div className="text-center">
          ...
          <p className="mt-4">
            Powerful features designed to enhance collaboration, boost
        ...
        <div className="@min-4xl:max-w-full @min-4xl:grid-cols-3 mx-auto mt-8 grid max-w-sm gap-6 *:text-center md:mt-16">
          <Card className="group shadow-black-950/5">
            ...
            <CardContent>
              <p className="text-sm">
                Centralize all your knowledge and resources in one intelligent
                workspace. Find what you need instantly and accelerate
                decision-making.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="group shadow-black-950/5">
            ...
            <CardContent>
              <p className="text-sm">
                Work together effortlessly with real-time collaboration tools
                that keep your entire team aligned.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="group shadow-black-950/5">
            ...
            <CardContent>
              <p className="text-sm">
                Choose from 100+ leading LLMs and seamlessly call any model on
                demand.
              </p>
            </CardContent>
          </Card>
