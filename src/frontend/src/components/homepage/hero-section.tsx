  ...
  return (
    ...
    >
      ...
      <p className="relative z-50 mx-auto mt-4 max-w-lg px-4 text-center text-base/6 text-gray-600 dark:text-gray-200">
        Connect any LLM to your internal knowledge sources and chat with it in
        real time alongside your team.
      </p>
      ...
      >
        <div className="rounded-[24px] border border-neutral-200 bg-white p-2 dark:border-neutral-700 dark:bg-black">
          ...
          <img
            ...
            alt="Langflow workspace screenshot"
            className="rounded-[20px] block dark:hidden w-full h-auto"
          />
          {/* Dark mode image */}
          <img
            src="/homepage/main_demo.webp"
            alt="Langflow workspace screenshot"
            className="rounded-[20px] hidden dark:block w-full h-auto"
          />
        </div>
      </div>
    </div>
