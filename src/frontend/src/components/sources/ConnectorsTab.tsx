          ...
          >
            <div className="flex items-center justify-between space-x-4 p-4">
              <h3 className="text-xl font-semibold">
                {t(`connectors.categories.${category.title}`)}
              </h3>
                    ...
                    <Card className="h-full flex flex-col overflow-hidden border-transparent transition-all duration-200 hover:border-primary/50">
                      ...
                      <CardContent className="pb-4">
                        <p className="text-sm text-muted-foreground">
                          {t(
                            `connectors.descriptions.${connector.description}`,
                          )}
                        </p>
                      </CardContent>
                      ...
                      <CardFooter className="mt-auto pt-2">
                        {connector.status === "available" && (
                          <Link
                            to={`/spaces/${searchSpaceId}/connectors/add/${connector.id}`}
                            className="w-full"
                          >
