  ...
  return (
    <>
        ...
        <div className="edit-flow-arrangement">
          ...
          {isMaxLength && (
            <span className="edit-flow-span">
              {t("validation.characterLimitReached")}
            </span>
          )}
          {isMinLength && (
            <span className="edit-flow-span">
              {t("validation.minimumCharactersRequired", { count: minLength })}
            </span>
          )}
          {isInvalidName && (
            <span className="edit-flow-span">
      ...
      <Form.Field name="description">
        ...
        <Form.Message match="valueMissing" className="field-invalid">
          {t("validation.pleaseEnterDescription")}
        </Form.Message>
        <div className="mt-3">
