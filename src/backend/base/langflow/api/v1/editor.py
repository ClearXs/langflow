...
async def get_editor_content(
    ...
    from langflow.utils.blocknote_converter import convert_markdown_to_blocknote
...
async def save_document(
    ...
    """
    from langflow.tasks.document_reindex_tasks import reindex_document_task
    ...
    # Queue reindex task
    reindex_document_task.delay(document_id, str(current_user.id))
