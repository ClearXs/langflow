...
from langflow.services.database.models import ConnectorType

logger = logging.getLogger(__name__)

# Mapping of connector types to their corresponding Celery task names
CONNECTOR_TASK_MAP = {
    ConnectorType.SLACK: "index_slack_messages",
    ConnectorType.NOTION: "index_notion_pages",
    ConnectorType.GITHUB: "index_github_repos",
    ConnectorType.LINEAR: "index_linear_issues",
    ConnectorType.JIRA: "index_jira_issues",
    ConnectorType.CONFLUENCE: "index_confluence_pages",
    ConnectorType.CLICKUP: "index_clickup_tasks",
    ConnectorType.GOOGLE_CALENDAR: "index_google_calendar_events",
    ConnectorType.AIRTABLE: "index_airtable_records",
    ConnectorType.GMAIL: "index_google_gmail_messages",
    ConnectorType.DISCORD: "index_discord_messages",
    ConnectorType.LUMA: "index_luma_events",
    ConnectorType.ELASTICSEARCH: "index_elasticsearch_documents",
    ConnectorType.WEBCRAWLER: "index_crawled_urls",
    ConnectorType.BOOKSTACK: "index_bookstack_pages",
}
...
def create_periodic_schedule(
    ...
    try:
        ...
        task_map = {
            ConnectorType.SLACK: index_slack_messages_task,
            ConnectorType.NOTION: index_notion_pages_task,
            ConnectorType.GITHUB: index_github_repos_task,
            ConnectorType.LINEAR: index_linear_issues_task,
            ConnectorType.JIRA: index_jira_issues_task,
            ConnectorType.CONFLUENCE: index_confluence_pages_task,
            ConnectorType.CLICKUP: index_clickup_tasks_task,
            ConnectorType.GOOGLE_CALENDAR: index_google_calendar_events_task,
            ConnectorType.AIRTABLE: index_airtable_records_task,
            ConnectorType.GMAIL: index_google_gmail_messages_task,
            ConnectorType.DISCORD: index_discord_messages_task,
            ConnectorType.LUMA: index_luma_events_task,
            ConnectorType.ELASTICSEARCH: index_elasticsearch_documents_task,
            ConnectorType.WEBCRAWLER: index_crawled_urls_task,
            ConnectorType.BOOKSTACK: index_bookstack_pages_task,
        }
