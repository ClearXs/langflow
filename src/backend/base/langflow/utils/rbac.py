...
async def get_user_membership(
    ...
    Returns:
        SpaceMembership if found, None otherwise
    """
    result = await session.execute(
        ...
        .filter(
            ...
            SpaceMembership.space_id == search_space_id,
        )
    )
...
async def check_permission(
    ...
    Returns:
        SpaceMembership if permission granted
...
async def check_search_space_access(
    ...
    Returns:
        SpaceMembership if user has access
...
async def get_search_space_with_access_check(
    ...
    Returns:
        Tuple of (Space, SpaceMembership)
...
async def get_default_role(
    ...
    Returns:
        Default Role or None
    """
    result = await session.execute(
        select(Role).filter(
            Role.search_space_id == search_space_id,  # Fixed: use search_space_id
