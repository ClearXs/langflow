...
from langflow.services.database.models.entity.crud import create_entity, merge_entities
...
async def _extract_entities_and_relations(
    ...
    async with async_session_maker() as session:
        ...
        if not space.enable_knowledge_graph:
            ...
            return {"entities_count": 0, "relations_count": 0, "skipped": True}
        ...
        if not text_content:
            ...
            return {"entities_count": 0, "relations_count": 0, "no_content": True}
...
@celery_app.task(name="langflow.tasks.extract_entities_from_document", bind=True)
