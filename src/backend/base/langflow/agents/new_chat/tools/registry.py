...
1. Create your tool file (e.g., `tools/my_tool.py`):
    ...
    def create_my_tool(space_id: int, db_session: AsyncSession):
        @tool
...
class ToolDefinition:
    ...
    Attributes:
        ...
        requires: List of dependency names this tool needs (e.g., "space_id", "db_session")
...
BUILTIN_TOOLS: list[ToolDefinition] = [
    ...
    ToolDefinition(
        ...
        requires=["space_id", "db_session", "connector_service"],
    ),
