...
from langflow.agents.new_chat.context import SurfSenseContextSchema
from langflow.agents.new_chat.llm_config import AgentConfig
from langflow.agents.new_chat.system_prompt import (
    build_configurable_system_prompt,
    build_surfsense_system_prompt,
)
from langflow.agents.new_chat.tools import build_tools
...
def create_surfsense_deep_agent(
    ...
    Args:
        ...
        agent_config: Optional AgentConfig from LLMConfig for prompt configuration.
    ...
    Examples:
        ...
        agent = create_surfsense_deep_agent(llm, space_id, db_session, ...)

        # Create agent with custom prompt configuration
        agent = create_surfsense_deep_agent(
            llm, space_id, db_session, ...,
    ...
    if agent_config is not None:
        # Use configurable prompt with settings from LLMConfig
