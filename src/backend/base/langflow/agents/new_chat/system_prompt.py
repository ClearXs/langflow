...
1. System Instructions (configurable via LLMConfig)
2. Tools Instructions (always included, not configurable)
3. Citation Instructions (toggleable via LLMConfig.citations_enabled)
"""

from datetime import UTC, datetime

# Default system instructions - can be overridden via LLMConfig.system_instructions
