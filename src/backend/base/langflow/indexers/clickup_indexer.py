...
from langflow.connectors.clickup_connector import ClickUpConnector
...
async def index_clickup_tasks(
    ...
    Args:
        ...
        space_id: ID of the search space
    ...
    try:
        ...
        connector = await get_connector_by_id(
            session, connector_id, ConnectorType.CLICKUP
        )
            ...
            for task in tasks:
                try:
                    ...
                    unique_identifier_hash = generate_unique_identifier_hash(
                        DocumentType.CLICKUP_CONNECTOR, task_id, space_id
                    )

                    # Generate content hash
                    content_hash = generate_content_hash(task_content, space_id)
