...
from langflow.connectors.elasticsearch_connector import ElasticsearchConnector
from langflow.services.database.models.connector import Connector
        ...
        try:
            ...
            async for hit in es_connector.scroll_search(
                ...
                try:
                    ...
                    # Create content hash
                    content_hash = generate_content_hash(content, space_id)
