...
from langflow.connectors.google_calendar_connector import GoogleCalendarConnector
from langflow.services.database.models import ConnectorType, Document, DocumentType
...
async def index_google_calendar_events(
    ...
    try:
        ...
        connector = await get_connector_by_id(
            session, connector_id, ConnectorType.GOOGLE_CALENDAR
        )
