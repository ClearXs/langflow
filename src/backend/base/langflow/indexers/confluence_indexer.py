...
from langflow.connectors.confluence_connector import ConfluenceConnector
from langflow.services.database.models.connector.model import ConnectorType
from langflow.services.database.models.document import Document
from langflow.services.database.models.document.model import DocumentType
from langflow.services.deps import get_settings_service
from langflow.services.llm.llm_service import get_user_long_context_llm
...
async def index_confluence_pages(
    ...
    Args:
        ...
        space_id: ID of the search space to store documents in
        user_id: User ID
    ...
    try:
        ...
        connector = await get_connector_by_id(
            session, connector_id, ConnectorType.CONFLUENCE
        )
        ...
        for page in pages:
            try:
                ...
                unique_identifier_hash = generate_unique_identifier_hash(
                    DocumentType.CONFLUENCE_CONNECTOR, page_id, space_id
                )

                # Generate content hash
                content_hash = generate_content_hash(full_content, space_id)
