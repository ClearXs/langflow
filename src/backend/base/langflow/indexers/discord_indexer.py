...
from langflow.connectors.discord_connector import DiscordConnector
...
async def index_discord_messages(
    ...
    try:
        ...
        connector = await get_connector_by_id(
            session, connector_id, ConnectorType.DISCORD
        )
                ...
                try:
                    ...
                    for channel in channels:
                        ...
                        unique_identifier_hash = generate_unique_identifier_hash(
                            DocumentType.DISCORD_CONNECTOR, channel_id, space_id
                        )

                        # Generate content hash
                        content_hash = generate_content_hash(
                            combined_document_string, space_id
                        )
