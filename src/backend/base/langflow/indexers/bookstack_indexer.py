...
from langflow.connectors.bookstack_connector import BookStackConnector
...
async def index_bookstack_pages(
    ...
    try:
        ...
        connector = await get_connector_by_id(
            session, connector_id, ConnectorType.BOOKSTACK
        )
        ...
        for page in pages:
            try:
                ...
                unique_identifier_hash = generate_unique_identifier_hash(
                    DocumentType.BOOKSTACK_CONNECTOR, page_id, space_id
                )
