...
from langflow.connectors.airtable_connector import AirtableConnector
...
async def index_airtable_records(
    ...
    try:
        ...
        connector = await get_connector_by_id(
            session, connector_id, ConnectorType.AIRTABLE
        )
        ...
        if credentials.is_expired:
            ...
            # TODO: Implement refresh_airtable_token for langflow
